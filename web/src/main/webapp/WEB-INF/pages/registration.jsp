...
<div class="menu" style="background-color: #cbedf2">
    <ul id="nav">
        ...
        <li>
            <a href="${pageContext.request.contextPath}/">Авторизация</a>
        </li>
    </ul>
</div>
<form action="${pageContext.request.contextPath}/registration" method="post" class="frm" style="margin: 0 auto">
    <br/>
